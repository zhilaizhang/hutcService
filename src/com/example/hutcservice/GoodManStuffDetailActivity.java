...
public class GoodManStuffDetailActivity extends BaseActivity{
	...
	public static GoodManStuff twostuff = null;
	// 图片的资源ID
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.goodmanstuffdetail);
		images.clear();
		...
		t_time=(TextView)findViewById(R.id.goodman_fabu_time);
		t_type.setText(type);
		((ImageView) findViewById(R.id.stuff_image)).setImageBitmap(twostuff.getpPicture());
		//images.add(twostuff.getImage());
		t_title.setText(twostuff.getpTitle());
		//t_price.setText(String.valueOf(twostuff.getPrice()));
		t_content.setText(twostuff.getpDetail());
		t_man.setText(twostuff.getlinkMan());
		t_phone.setText(twostuff.getlinkPhone());
		t_QQ.setText(twostuff.getlinkQQ());
		t_time.setText(twostuff.getpTime());
		}
