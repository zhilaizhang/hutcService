...
public class FuLiTongXueActivity extends Activity {
	...
	private void test() {
		progressDialog = ProgressDialog.show(FuLiTongXueActivity.this,
				"Loading...", "Please wait...", true, false);
		new Thread() {
			public void run() {
				GetStuff gs = new GetStuff();
				goodmanstuffs = gs.getFuLiTongXueStuff();
					...
					if (goodmanstuffs.get(position) != null) {
						...
						if (!String.valueOf(
							...
							Intent intent = new Intent(
									FuLiTongXueActivity.this,
									GoodManStuffDetailActivity.class);
							Bundle bundle = new Bundle();

							bundle.putString("type", "福利同学");
							intent.putExtras(bundle);
							GoodManStuffDetailActivity.twostuff = goodmanstuffs
									.get(position);

							FuLiTongXueActivity.this.startActivity(intent);
