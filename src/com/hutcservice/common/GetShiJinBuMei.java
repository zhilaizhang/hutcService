...
//与服务器端的webservice连接获取拾金不昧的信息


public class GetShiJinBuMei extends AsyncTask<String,Integer,ArrayList<String>>{
    public	ArrayList<String>  alStr=new ArrayList<String>();
 
	@Override
	protected ArrayList<String> doInBackground(String... params) {
		// TODO Auto-generated method stub
		String SOAP_ACTION = Config.namespace+"getShiJinBuMei";
        String METHOD_NAME = "getShiJinBuMei";
        String NAMESPACE = Config.namespace;
        String URL = Config.url;
        
     try {
            SoapObject Request = new SoapObject(NAMESPACE, METHOD_NAME);           
            //Request.addProperty("uerid", params[0]);  //分类id        
