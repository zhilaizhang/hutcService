...
public class GetQiuGouAll extends AsyncTask<String, Integer, ArrayList<String>> {
	...
	protected ArrayList<String> doInBackground(String... params) {
		...
		String SOAP_ACTION = Config.namespace+"getQiuGouAll";
		String METHOD_NAME = "getQiuGouAll";
