...
public class GetFuLiTongXueByUid extends AsyncTask<String,Integer,ArrayList<String>>{
    public	ArrayList<String>  alStr=new ArrayList<String>();
 
	@Override
	protected ArrayList<String> doInBackground(String... params) {
		// TODO Auto-generated method stub
		String SOAP_ACTION = Config.namespace+"getFuLiTongXueById";
        String METHOD_NAME = "getFuLiTongXueById";
