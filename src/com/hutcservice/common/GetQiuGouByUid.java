...
public class GetQiuGouByUid extends AsyncTask<String,Integer,ArrayList<String>>{
    public	ArrayList<String>  alStr=new ArrayList<String>();
	@Override
	protected ArrayList<String> doInBackground(String... params) {
		// TODO Auto-generated method stub
		String SOAP_ACTION =Config.namespace+"getQiuGouByUid";
        String METHOD_NAME = "getQiuGouByUid";
