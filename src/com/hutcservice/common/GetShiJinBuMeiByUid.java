...
public class GetShiJinBuMeiByUid extends AsyncTask<String,Integer,ArrayList<String>>{
    public	ArrayList<String>  alStr=new ArrayList<String>();
 
	@Override
	protected ArrayList<String> doInBackground(String... params) {
		// TODO Auto-generated method stub
		String SOAP_ACTION = Config.namespace+"getShiJinBuMeiByUid";
        String METHOD_NAME = "getShiJinBuMeiByUid";
        String NAMESPACE = Config.namespace;
        String URL = Config.url;
        
     try {
            SoapObject Request = new SoapObject(NAMESPACE, METHOD_NAME);           
            Request.addProperty("uid", params[0]);  //∑÷¿‡id        
